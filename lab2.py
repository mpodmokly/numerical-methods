...
print(f"cond linear: {cond_linear}")
print(f"cond quadratic: {cond_quadratic}\n")
...
print(f"Correct malignant (linear): {malignant_linear}/{malignant_no}")
print(f"Correct benign (linear): {benign_linear}/{benign_no}")
print(f"Correct malignant (quadratic): {malignant_quadratic}/{malignant_no}")
print(f"Correct benign (quadratic): {benign_quadratic}/{benign_no}")
